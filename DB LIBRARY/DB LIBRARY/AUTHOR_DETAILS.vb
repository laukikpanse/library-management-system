...
Public Class AUTHOR_DETAILS
    ...
    Private Sub AUTHOR_DETAILS_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If Len(Trim(TextBox3.Text)) = 0 Then
            MessageBox.Show("Please enter AUTHOR ADDRESS", "Input Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            TextBox3.Focus()
            Exit Sub
        End If
        ...
        If Len(Trim(TextBox5.Text)) = 0 Then
            MessageBox.Show("Please enter AUTHOR CONTACT", "Input Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            TextBox5.Focus()
            Exit Sub
        End If
        ...
        Dim cb As String = ("insert into AUTHOR([AU_ID],[AU_NAME],[AU_ADDRESS],[ISBN],[CONTACT]) values ('" & TextBox1.Text & "','" & TextBox2.Text & "','" & TextBox3.Text & "','" & TextBox4.Text & "','" & TextBox5.Text & "')")
        ...
        MessageBox.Show("Thankyou AUTHOR added successfully")
